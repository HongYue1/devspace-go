...
DevSpace یک سرور MCP خودمیزبان است که به دستیارهای هوش مصنوعی اجازه می‌دهد کد را در پروژه‌های محلی واقعی شما بخوانند، ویرایش کنند، جستجو کنند و اجرا کنند — فایل‌های شما، ابزارهای شما، ترمینال شما — بدون آپلود هیچ چیزی به شخص ثالث. شما آن را روی ماشین خود اجرا می‌کنید.
