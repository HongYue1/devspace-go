...
DevSpace — это самостоятельно размещаемый MCP-сервер, который позволяет ИИ-ассистентам читать, редактировать, искать и запускать код в ваших реальных локальных проектах — ваши файлы, ваши инструменты, ваш терминал — без загрузки чего-либо третьим лицам. Вы запускаете его на своём компьютере.
...
```
.devspace/
└── config.json       ← разрешённые корни, порт, оболочка, язык
```
