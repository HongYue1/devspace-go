...
DevSpace هو خادم MCP ذاتي الاستضافة يتيح للمساعدين الذكاء الاصطناعي قراءة وتحرير والبحث وتشغيل الكود في مشاريعك المحلية الحقيقية — ملفاتك، أدواتك، الطرفية الخاصة بك — دون تحميل أي شيء إلى طرف ثالث. تقوم بتشغيله على جهازك، وتعرضه عبر نفق تتحكم به.
