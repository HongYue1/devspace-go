...
Το DevSpace είναι ένας αυτο-φιλοξενούμενος MCP διακομιστής που επιτρέπει στους βοηθούς AI να διαβάζουν, να επεξεργάζονται, να αναζητούν και να εκτελούν κώδικα στα πραγματικά τοπικά σας έργα — τα αρχεία σας, τα εργαλεία σας, το τερματικό σας — χωρίς να ανεβάζουν τίποτα σε τρίτο μέρος. Το εκτελείτε στον υπολογιστή σας.
...
```
.devspace/
└── config.json       ← επιτρεπόμενες ρίζες, θύρα, κέλυφος, γλώσσα
```
